...
Private Const NPC_CENTINELA       As Integer = 117  'Índice del NPC en el .dat
...
Private Const TIEMPO_PASAR_BASE   As Integer = 40 'Tiempo minimo fijo para volver a pasar

Private Const TIEMPO_PASAR_RANDOM As Integer = 30 'Tiempo máximo para el random para que el centinela vuelva a pasar
                ...
                If UserIndex <> 0 Then
                    ...
                    If TActual - .SpawnTime >= 5000 Then
                        ...
                        If Not UserList(UserIndex).flags.CentinelaOK Then
                            Call WritePlayEffect(UserIndex, SND_WARP, Npclist(.NpcIndex).Pos.X, Npclist(.NpcIndex).Pos.Y)
...
Private Sub CentinelaFinalCheck(ByVal CentiIndex As Integer)
    ...
    With Centinela(CentiIndex)
        ...
        If Not UserList(UserIndex).flags.CentinelaOK Then
            ...
            'Logueamos el evento
            Call LogCentinela("Centinela echó a " & UserName & " por uso de macro inasistido.")
            
            'Avisamos a los admins
            Call SendData(SendTarget.ToAdmins, 0, PrepareMessageConsoleMsg("Servidor> El centinela ha echado a " & UserName & ".", FontTypeNames.FONTTYPE_SERVER, eMessageType.Admin))
            
            ' Evitamos loguear el logout
            .RevisandoUserIndex = 0
            
            Call Protocol.Kick(UserIndex, "Has sido echado del juego.")
        End If
        ...
        With Centinela(Index)
            ...
            If .Activo Then
                ...
                Else
                    ...
                    If distancia(Npclist(.NpcIndex).Pos, UserList(UserIndex).Pos) > 5 Then
