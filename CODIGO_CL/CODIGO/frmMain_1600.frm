...
Begin VB.Form frmMain_1600 
   ...
   EndProperty
   ForeColor       =   &H00000000&
   Icon            =   "frmMain_1600.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   PaletteMode     =   1  'UseZOrder
   Picture         =   "frmMain_1600.frx":000C
   ScaleHeight     =   899
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   1598
   ...
   Begin RichTextLib.RichTextBox RecTxt 
      ...
      Appearance      =   0
      TextRTF         =   $"frmMain_1600.frx":35D7C
   ...
   Begin VB.PictureBox picHechiz 
      ...
      Picture         =   "frmMain_1600.frx":35DF9
      ScaleHeight     =   360
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   338
      TabIndex        =   40
   ...
   Begin VB.PictureBox PicStats 
      ...
      Begin VB.Image imgOpciones 
         Height          =   495
         Left            =   15
         Picture         =   "frmMain_1600.frx":409D9
         Top             =   150
         Width           =   1680
      End
   ...
   Begin VB.Image imgHome 
      Height          =   480
      Left            =   6720
      Picture         =   "frmMain_1600.frx":455F3
      Top             =   120
      Visible         =   0   'False
      Width           =   480
   End
   ...
   Begin VB.Image imgDopa 
      Height          =   480
      Left            =   6120
      Picture         =   "frmMain_1600.frx":45E28
      Top             =   120
      Visible         =   0   'False
      Width           =   480
   End
   Begin VB.Image imgButton 
      ...
      Index           =   6
      Left            =   18120
      Picture         =   "frmMain_1600.frx":49762
      Top             =   8640
      Width           =   675
   End
   ...
   Begin VB.Image imgInvisible 
      Height          =   480
      Left            =   4920
      Picture         =   "frmMain_1600.frx":49F5E
      Top             =   120
      Visible         =   0   'False
      Width           =   480
   End
   Begin VB.Image imgParalisis 
      Height          =   480
      Left            =   5520
      Picture         =   "frmMain_1600.frx":4B086
      Top             =   120
      Visible         =   0   'False
      Width           =   480
   End
   Begin VB.Image imgExp 
      Height          =   105
      Left            =   16740
      Picture         =   "frmMain_1600.frx":4C358
      Top             =   13200
      Width           =   6330
   End
   ...
   Begin VB.Image CmdLanzar 
      Height          =   885
      Left            =   17040
      MouseIcon       =   "frmMain_1600.frx":4D825
      MousePointer    =   99  'Custom
      Top             =   7680
      Visible         =   0   'False
      Width           =   3465
   ...
   Begin VB.Image STAShp 
      Height          =   375
      Left            =   16845
      Picture         =   "frmMain_1600.frx":4D977
      Top             =   11430
      Width           =   2970
   End
   Begin VB.Image Hpshp 
      ...
      Left            =   16860
      MousePointer    =   99  'Custom
      Picture         =   "frmMain_1600.frx":4EC7E
      Top             =   9945
      Width           =   2970
   End
   Begin VB.Image COMIDAsp 
      Height          =   375
      Left            =   17160
      Picture         =   "frmMain_1600.frx":5013C
      Top             =   12120
      Width           =   900
   End
   Begin VB.Image AGUAsp 
      Height          =   375
      Left            =   18660
      Picture         =   "frmMain_1600.frx":508E0
      Top             =   12120
      Width           =   915
   End
   ...
   Begin VB.Image MANShp 
      Height          =   375
      Left            =   16860
      Picture         =   "frmMain_1600.frx":51043
      Top             =   10680
      Width           =   2970
   End
   ...
   End
End
Attribute VB_Name = "frmMain_1600"
...
Private Sub Form_Load()
    ...
    imgExp.visible = True
    imgExp.Picture = LoadPicture(DirInterface & "main\exp1600.jpg")
    picHechiz(0).Picture = LoadPicture(DirInterface & "main\spellfound_new.jpg")
    Me.Picture = LoadPicture(DirInterface & "main\VentanaPrincipal1600x900.jpg")
        ...
        If MouseShift = 0 Then
            If MouseBoton <> vbRightButton Then
                ...
                Else
                    ...
                    'Splitted because VB isn't lazy!
                    If UsingSkill = Robar Or UsingSkill = eSkill.Pesca Or UsingSkill = eSkill.Talar Or UsingSkill = eSkill.Mineria Or UsingSkill = FundirMetal Or UsingSkill = TeleportInvoker Then
...
Private Sub PicInv_Click()
    ...
    If MirandoSkins And Inventario.SelectedItem > 0 Then
        FrmSkin.InvSkin_Setting Inventario.ObjIndex(Inventario.SelectedItem)
    End If
End Sub
    ...
    If (Button = vbRightButton) And (Not Comerciando) Then
        If Inventario.GrhIndex(Inventario.SelectedItem) > 0 Then
            ...
            If Last_I > 0 And Last_I <= MAX_INVENTORY_SLOTS Then
                ...
                If Position = 0 Then
                    i = 3057
                    Call Get_Image(DirGraficos & GRH_RESOURCE_FILE, CStr(3057), data, False)
