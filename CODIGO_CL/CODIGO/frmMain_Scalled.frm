...
Begin VB.Form frmMain_Scalled 
   ...
   Begin RichTextLib.RichTextBox RecTxt 
      ...
      Appearance      =   0
      TextRTF         =   $"frmMain_Scalled.frx":0000
   ...
   Begin VB.Image imgHome 
      Height          =   480
      Left            =   2400
      Picture         =   "frmMain_Scalled.frx":007E
      Top             =   3960
      Visible         =   0   'False
      Width           =   480
   End
   Begin VB.Image imgParalisis 
      Height          =   330
      Left            =   1320
      Picture         =   "frmMain_Scalled.frx":08B3
      Top             =   4080
      Visible         =   0   'False
      Width           =   345
   End
   Begin VB.Image imgInvisible 
      Height          =   330
      Left            =   720
      Picture         =   "frmMain_Scalled.frx":1B85
      Top             =   4080
      Visible         =   0   'False
      Width           =   330
   End
   Begin VB.Image imgDopa 
      Height          =   330
      Left            =   1920
      Picture         =   "frmMain_Scalled.frx":2D68
      Top             =   4080
      Visible         =   0   'False
      Width           =   330
   End
   ...
   Begin VB.Image STAShp 
      Height          =   375
      Left            =   22170
      Picture         =   "frmMain_Scalled.frx":60C3
      Top             =   13740
      Width           =   5970
   End
   Begin VB.Image Hpshp 
      ...
      Left            =   22170
      MousePointer    =   99  'Custom
      Picture         =   "frmMain_Scalled.frx":8F1A
      Top             =   11955
      Width           =   5970
   End
   Begin VB.Image COMIDAsp 
      Height          =   375
      Left            =   22470
      Picture         =   "frmMain_Scalled.frx":BEE0
      Top             =   14640
      Width           =   2550
   End
   Begin VB.Image AGUAsp 
      Height          =   375
      Left            =   25290
      Picture         =   "frmMain_Scalled.frx":DB23
      Top             =   14640
      Width           =   2550
   End
   ...
   Begin VB.Image MANShp 
      Height          =   375
      Left            =   22170
      Picture         =   "frmMain_Scalled.frx":F8B1
      Top             =   12840
      Width           =   5970
   End
   ...
   End
End
Attribute VB_Name = "frmMain_Scalled"
...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(DirInterface & "main\VentanaPrincipal.jpg")
