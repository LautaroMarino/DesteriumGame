...
Begin VB.Form frmPanelGm 
   ...
   Begin VB.Frame Frame 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CommandButton cmdCONDEN 
            ...
            Width           =   1785
         End
         Begin VB.CommandButton cmdForgive2 
            Caption         =   "/PERDONCAOS"
            CausesValidation=   0   'False
            Height          =   315
            Left            =   30
         ...
         Begin VB.CommandButton cmdNOREAL 
            ...
            Width           =   1815
         End
         Begin VB.CommandButton cmbForgive1 
            Caption         =   "/PERDONARMADA"
            CausesValidation=   0   'False
            Height          =   315
            Left            =   1860
            TabIndex        =   83
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton cmdUNBAN 
            ...
            Width           =   825
         End
         Begin VB.CommandButton cmbBanAccount 
            Caption         =   "CUENTA"
            CausesValidation=   0   'False
            BeginProperty Font 
               Name            =   "Tahoma"
   ...
   Begin VB.Frame Frame 
      ...
      Top             =   840
      Width           =   3975
      Begin VB.CommandButton cmbSorteos 
         Caption         =   "SORTEOS"
         CausesValidation=   0   'False
         Height          =   315
         Left            =   1440
...
Private Sub cmbBanAccount_Click()
 '/BAN
    Dim tStr As String
    ...
    If LenB(Nick) <> 0 Then
        tStr = InputBox("Escriba el motivo del ban.", "BAN a la cuenta de " & Nick)
        DataDay = InputBox("Escriba la fecha en la que la cuenta se va a desbanear. Utilice formato 'dd/mm/aa'", "BAN a la cuenta de " & Nick)
        
        If LenB(tStr) <> 0 Then If MsgBox("¿Seguro desea banear la cuenta de " & Nick & "?", vbYesNo, "Atencion!") = vbYes Then Call WriteBanChar(Nick, tStr, 1, DataDay)
    End If
End Sub

Private Sub cmbForgive1_Click()
    ...
    If LenB(Nick) <> 0 Then Call WriteForgive(Nick, True)
End Sub
...
Private Sub cmbSorteos_Click()
    Call FrmSorteos.Show(, FrmMain)
End Sub
...
Private Sub cmdBAN_Click()
    ...
    If LenB(Nick) <> 0 Then
        ...
        DataDay = InputBox("Escriba la fecha en la que el personaje se va a desbanear. Utilice formato 'dd/mm/aa'", "BAN a " & Nick)
        
        If LenB(tStr) <> 0 Then If MsgBox("¿Seguro desea banear a " & Nick & "?", vbYesNo, "Atencion!") = vbYes Then Call WriteBanChar(Nick, tStr, 0, DataDay)
    End If
...
Private Sub cmdBOV_Click()
    ...
    If LenB(Nick) <> 0 Then Call WriteRequestCharBank(Nick, 1)
End Sub
...
Private Sub cmdDONDE_Click()
    ...
    If LenB(Nick) <> 0 Then Call WriteWhere(Nick, False)
End Sub
...
Private Sub cmdForgive2_Click()
    ...
    If LenB(Nick) <> 0 Then Call WriteForgive(Nick, False)
End Sub
...
Private Sub cmdActualiza_Click()
    Call WriteRequestUserList(True)
End Sub
