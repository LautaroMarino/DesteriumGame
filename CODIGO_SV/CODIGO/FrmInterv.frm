...
Public Sub AplicarIntervalos()
    ...
    IntervalDrop = val(txtDrop.Text)
    IntervaloPuedeCastear = val(txtCast.Text)
    IntervalMessage = val(txtMessage.Text)
    IntervalInfoMao = val(txtInfoMao.Text)
...
Private Sub Command2_Click()
    ...
    Call WriteVar(IniPath & "Server.ini", "INTERVALOS", "IntervaloDrop", Str(IntervalDrop))
    Call WriteVar(IniPath & "Server.ini", "INTERVALOS", "IntervaloChat", Str(IntervalMessage))
    Call WriteVar(IniPath & "Server.ini", "INTERVALOS", "IntervaloInfoMao", Str(IntervalInfoMao))
    Call WriteVar(IniPath & "Server.ini", "INTERVALOS", "IntervaloPuedeCastear", Str(IntervaloPuedeCastear))
